...
- [x] Learning list/detail/approve/reject/edit endpoints exist.
...
- [x] Learning queue is visible through API.
...
endpoints, plus profile list/detail endpoints. No Web UI or WebSocket yet.
OpenAI-compatible helper logic is split into `api/openai_compat.py`; streaming,
multimodal input, and `/v1/responses` remain open.
