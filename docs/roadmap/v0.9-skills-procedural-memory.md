# v0.9: Skills As Procedural Memory [FIRST SLICE]
...
- [ ] Full owner-reviewed activation/edit/rollback workflow is not complete.
- [ ] Background learning reviewer does not propose skills yet.
- [ ] Dedicated lifecycle command coverage remains incomplete.
...
- [ ] Skill patching is fully atomic with rollback on validation failure.
...
- Full owner-reviewed activation, rollback, and command lifecycle remain.
