# v0.9: Skills As Procedural Memory [COMPLETED]
...
- Skill drafts are inert until activated.
- Validation blocks unsafe paths and malformed files.
- Skill patching is atomic.
...
- There is no safe lifecycle for creating, patching, validating, activating,
  disabling, or rolling back skills.
