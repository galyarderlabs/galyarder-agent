...
Shipped with first-slice compression (summarize middle, fallback, prune tool
outputs) but lacks dedicated advanced tests/token budgets/iterative structured
compression.
