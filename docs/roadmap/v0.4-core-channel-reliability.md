...
1. Wire normalized delivery results into channel send paths.
2. Harden WhatsApp bridge diagnostics.
3. Improve channel-specific formatting and session diagnostics.
   - QR/login status.
