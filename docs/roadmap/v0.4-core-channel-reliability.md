...
- Each core channel supports text commands.
- Media receive creates a usable media reference.
- Media send reports delivery failure clearly.
- Channel capability flags are available to the agent loop.
- Long messages split safely per channel.
- Channel reconnects preserve or recover session mapping.
