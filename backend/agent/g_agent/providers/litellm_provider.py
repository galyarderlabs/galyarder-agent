...
class LiteLLMProvider(LLMProvider):
    ...
    async def chat(
        ...
        # For Gemini direct provider, ensure gemini/ prefix if not already present.
        # Skip this when using custom OpenAI-compatible endpoints (vLLM/proxy).
        if (not self.is_vllm) and "gemini" in model.lower() and not model.startswith("gemini/"):
