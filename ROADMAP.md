...
- [x] `docs/roadmap/v0.9-skills-procedural-memory.md` — skill store/validator/manager/tool plus owner-reviewed skill apply/rollback shipped; atomic patching and background skill proposals remain.
