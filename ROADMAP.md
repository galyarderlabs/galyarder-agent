...
- [x] `docs/roadmap/v0.12-toolsets-mcp-execution.md` — local backend/toolset/MCP slice plus streamable HTTP transport shipped; Docker execution backend remains.
